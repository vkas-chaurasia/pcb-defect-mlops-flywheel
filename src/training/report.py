...
def generate_report():
    ...
    report_content = [
        ...
        f"![Training Results]({latest_folder}/results.png)",
        "\n### 2. Performance Curves (Precision, Recall, F1)",
        f"![Precision Curve]({latest_folder}/BoxP_curve.png)",
        f"![Recall Curve]({latest_folder}/BoxR_curve.png)",
